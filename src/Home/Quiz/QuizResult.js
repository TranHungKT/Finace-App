...
const medal = require('../../../icon/drawable-mdpi/medal.png');
const medalFail = require('../../../icon/drawable-mdpi/medalFail.png');
        ...
        <View style={styles.textPosition}>
          ...
          <View style={styles.button}>
            ...
            <Button style={styles.buttonBig}>
              <Text style={styles.textButtonBig}>
                Next</Text>
            </Button>
            </View>
      </View>
...
export default connect(mapStateToProps,{retryTest})(QuizResult)
